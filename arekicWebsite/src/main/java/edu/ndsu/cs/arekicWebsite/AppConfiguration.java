package edu.ndsu.cs.arekicWebsite;
...
@Configuration
@ComponentScan({ "edu.ndsu.cs.arekicWebsite" })
    ...
    public ServletContextInitializer initializer()
    {
        return new ServletContextInitializer()
        {
            ...
            public void onStartup(ServletContext servletContext) throws ServletException {
                servletContext.setInitParameter("tapestry.app-package", "edu.ndsu.cs.arekicWebsite");
                servletContext.setInitParameter("tapestry.development-modules", "edu.ndsu.cs.arekicWebsite.services.DevelopmentModule");
